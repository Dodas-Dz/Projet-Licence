	...
	{  
        ...
        const icons7=document.querySelector(".validity7");
              ...
              /*   else if (Confirmeremail()==false || Confirmernom()==false ||  Confirmerheure()==false || Confirmerprenom()==false)
                 {onchange=alert("Veuillez vérifier les champs !");
    ...
    */
               ...
               else if (Confirmeremail()==true && Confirmernom()==true && Confirmerheure()==true && Confirmerprenom()==true  && Confirmertel()==true)
                 {

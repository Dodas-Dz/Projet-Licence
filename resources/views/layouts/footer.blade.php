    ...
    <div class="container">
      <div class="list_footer">
        ...
        <div class="lists_footer">
          <h2>Services</h2>
          <ul>
            <li><a href="{{route('serviceweb')}}"><i class="fas fa-caret-right"></i> Site-web </a></li>
            <li><a href="{{route('serviceapp')}}"><i class="fas fa-caret-right"></i> App-Mobile</a></li>
            <li><a href="{{route('servicedes')}}"><i class="fas fa-caret-right"></i> Design</a></li>
          </ul>
        </div>
        <div class="lists_footer">
          <h2>Liens importants</h2>
          <ul>
            <li><a href="{{route('apropos')}}"><i class="fas fa-caret-right"></i> Acceuil</a></li>
            <li><a href="{{route('commandeuser')}}"><i class="fas fa-caret-right"></i> Commande</a></li>

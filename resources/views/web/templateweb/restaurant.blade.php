...
<head>
  ...
  ================================================== -->
    ...
    <!-- CSS
	================================================== -->
  	<link rel="stylesheet" href="{{asset('template/restaurant/css/zerogrid.css')}}">
	<link rel="stylesheet" href="{{asset('template/restaurant/css/style.css')}}">
	<link rel="stylesheet" href="{{asset('template/restaurant/css/lightbox.css')}}">
	
	<!-- Custom Fonts -->
    <link href="{{asset('template/restaurant/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
	
	
	<link  rel="stylesheet" href="{{asset('template/restaurant/css/menu.css')}}">
">
	<script src="template/restaurant/js/jquery1111.min.js" type="text/javascript"></script>
	<script src="template/restaurant/js/script.js"></script>
	...
	<div class="wrap-body">
		<div class="header">
			...
			<div class="custom-banner">
				<img src="template/restaurant/images/main.jpg">
			</div>
		</div>
		<!--////////////////////////////////////Container-->
						...
						<div class="row wrap-box"><!--Start Box-->
							...
							<div class="row">
								<div class="col-1-3">
									<div class="wrap-col">
										<div class="portfolio-box">
											<img src="template/restaurant/images/1.jpg" class="img-responsive" alt="">
										...
										<div class="portfolio-box">
											<img src="template/restaurant/images/4.jpg" class="img-responsive" alt="">
											<div class="portfolio-box-caption">
												<div class="portfolio-box-caption-content">
													<div class="project-category text-faded">
														<a href="#">Category</a>
								...
								<div class="col-1-3">
									<div class="wrap-col">
										<div class="portfolio-box">
											<img src="template/restaurant/images/2.jpg" class="img-responsive" alt="">
											<div class="portfolio-box-caption">
												<div class="portfolio-box-caption-content">
													<div class="project-category text-faded">
														<a href="#">Category</a>
										...
										<div class="portfolio-box">
											<img src="template/restaurant/images/5.jpg" class="img-responsive" alt="">
											<div class="portfolio-box-caption">
												<div class="portfolio-box-caption-content">
													<div class="project-category text-faded">
														<a href="#">Category</a>
								...
								<div class="col-1-3">
									<div class="wrap-col">
										<div class="portfolio-box">
											<img src="template/restaurant/images/3.jpg" class="img-responsive" alt="">
											<div class="portfolio-box-caption">
												<div class="portfolio-box-caption-content">
													<div class="project-category text-faded">
														<a href="#">Category</a>
										...
										<div class="portfolio-box">
											<img src="template/restaurant/images/6.jpg" class="img-responsive" alt="">
											<div class="portfolio-box-caption">
												<div class="portfolio-box-caption-content">
													<div class="project-category text-faded">
														<a href="#">Category</a>

...
<html>
	<head>
		...
		<link rel="stylesheet" href="{{asset('template/ethereal/assets/css/main.css')}}" />
		<noscript><link rel="stylesheet" href="{{asset('template/ethereal/assets/css/noscript.css')}}" /></noscript>
	</head>
						...
						<!-- Panel (Banner) -->
							<section class="panel banner right">
								...
								<div class="image filtered span-1-75" data-position="25% 25%">
									<img src="template/ethereal/images/pic01.jpg" alt="" />
								</div>
							</section>
						...
						<!-- Panel (Spotlight) -->
							<section class="panel spotlight medium right" id="first">
								...
								<div class="image filtered tinted" data-position="top left">
									<img src="template/ethereal/images/pic02.jpg" alt="" />
								</div>
							</section>
						...
						<!-- Panel (Spotlight) -->
							<section class="panel spotlight large left">
								...
								<div class="image filtered tinted" data-position="top right">
									<img src="template/ethereal/images/pic03.jpg" alt="" />
								</div>
							</section>
							...
							<section class="panel">
								...
								<div class="gallery">
									<div class="group span-3">
										<a href="template/ethereal/images/gallery/fulls/01.jpg" class="image filtered span-3" data-position="bottom"><img src="template/ethereal/images/gallery/thumbs/01.jpg" alt="" /></a>
										<a href="template/ethereal/images/gallery/fulls/02.jpg" class="image filtered span-1-5" data-position="center"><img src="template/ethereal/images/gallery/thumbs/02.jpg" alt="" /></a>
										<a href="template/ethereal/images/gallery/fulls/03.jpg" class="image filtered span-1-5" data-position="bottom"><img src="template/ethereal/images/gallery/thumbs/03.jpg" alt="" /></a>
									</div>
									...
									<div class="group span-4-5">
										<a href="template/ethereal/images/gallery/fulls/05.jpg" class="image filtered span-3" data-position="top"><img src="template/ethereal/images/gallery/thumbs/05.jpg" alt="" /></a>
										<a href="template/ethereal/images/gallery/fulls/06.jpg" class="image filtered span-1-5" data-position="center"><img src="template/ethereal/images/gallery/thumbs/06.jpg" alt="" /></a>
										<a href="template/ethereal/images/gallery/fulls/07.jpg" class="image filtered span-1-5" data-position="bottom"><img src="template/ethereal/images/gallery/thumbs/07.jpg" alt="" /></a>
										<a href="template/ethereal/images/gallery/fulls/08.jpg" class="image filtered span-3" data-position="top"><img src="template/ethereal/images/gallery/thumbs/08.jpg" alt="" /></a>
									</div>
									<a href="template/ethereal/images/gallery/fulls/09.jpg" class="image filtered span-2-5" data-position="right"><img src="template/ethereal/images/gallery/thumbs/09.jpg" alt="" /></a>
								</div>
							</section>
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<!-- Scripts -->
			<script src="template/ethereal/assets/js/jquery.min.js"></script>
			<script src="template/ethereal/assets/js/browser.min.js"></script>
			<script src="template/ethereal/assets/js/breakpoints.min.js"></script>
			<script src="template/ethereal/assets/js/main.js"></script>
